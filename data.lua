return {
	...
	{["Text"]="Research Points: ",["Value"]="return workspace.CountryData['%s'].Power.Political.Value"},
	{["Text"]="Research Points: ",["Value"]="return workspace.CountryData['%s'].Power.Political.Value"},
	{["Text"]="Political Power: ",["Value"]="return workspace.CountryData['%s'].Power.Research.Value"},
}
