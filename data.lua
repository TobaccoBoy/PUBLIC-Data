return {
	...
	{["Type"]="Economy",["Image"]="3044067171",["Text"]="Political Power: ",["Value"]="return math.ceil(workspace.CountryData['%s'].Power.Political.Value)"},
	{["Type"]="Economy",["Image"]="3044067171",["Text"]="Research Points: ",["Value"]="return math.ceil(workspace.CountryData['%s'].Power.Research.Value)"},
